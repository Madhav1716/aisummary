      ...
      >
        <View style={styles.section}>
          ...
          {settingsItems.map((item) => (
            <TouchableOpacity
              key={item.id}
              style={[styles.settingItem, { backgroundColor: isDark ? '#2a2a2a' : '#ffffff' }]}
            ...
            >
              <View style={styles.settingItemContent}>
                ...
                />
                <Text style={[styles.settingItemText, { color: isDark ? '#ffffff' : '#000000' }]}>
                  {item.title}
                </Text>
              </View>
              <MaterialCommunityIcons
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.infoItem, { backgroundColor: isDark ? '#2a2a2a' : '#ffffff' }]}>
            <Text style={[styles.infoLabel, { color: isDark ? '#a0a0a0' : '#666666' }]}>
              Version
            </Text>
